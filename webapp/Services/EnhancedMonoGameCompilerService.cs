...
public class EnhancedMonoGameCompilerService
{
    private readonly ILogger<EnhancedMonoGameCompilerService> _logger;
    ...
    public EnhancedMonoGameCompilerService(ILogger<EnhancedMonoGameCompilerService> logger, IConfiguration configuration, UserService userService)
    {
        _logger = logger;
